...
- 04/08 [Controller](https://github.com/traningEpamKz/homeAppliances/blob/master/src/main/java/kz/homeAppliances/appliances/Controller.java) в котором находится коллекция приборов, и через который производятся манипуляции над коллекцией приборов. 
